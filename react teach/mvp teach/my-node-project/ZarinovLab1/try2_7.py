...
# Сохранение данных спектрограммы в файл (формат .npy)
np.save("spectrum_data.npy", D_db)
...
# Сохранение графика спектрограммы как изображения (PNG)
plt.tight_layout()
...
print("Данные спектрограммы сохранены в файл 'spectrum_data.npy'")
print("Изображение спектрограммы сохранено в файл 'spectrogram.png'")
