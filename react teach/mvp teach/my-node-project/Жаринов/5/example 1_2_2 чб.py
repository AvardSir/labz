...
print("Минимальное значение (исходное):", np.min(gray_image))
print("Максимальное значение (исходное):", np.max(gray_image))
...
# Проверяем минимальные и максимальные значения после нормализации
print("Минимальное значение (нормализованное):", np.min(gray_image_out))
print("Максимальное значение (нормализованное):", np.max(gray_image_out))
