...
input_audio_path = "audio_with_noise.wav"  # Укажите путь к вашему аудиофайлу
...
output_audio_path = "audio_without_noise.wav"
sf.write(output_audio_path, output_audio, sr)

print(f"Аудиофайл с помехой успешно сохранен как '{output_audio_path}'")
