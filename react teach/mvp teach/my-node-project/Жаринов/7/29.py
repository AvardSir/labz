...
# ---------------------------------------------------------
image_deblur[:, :, 0] = restoration.wiener(input_image[:, :, 0], PSF_blur, noise_var)
image_deblur[:, :, 1] = restoration.wiener(input_image[:, :, 1], PSF_blur, noise_var)
image_deblur[:, :, 2] = restoration.wiener(input_image[:, :, 2], PSF_blur, noise_var)
# ---------------------------------------------------------
