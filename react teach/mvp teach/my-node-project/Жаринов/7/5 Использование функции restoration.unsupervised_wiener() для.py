...
# ---------------------------------------------------------
image_deblur[:,:,0],_ = restoration.unsupervised_wiener(blur_image[:,:,0], PSF_blur) 
image_deblur[:,:,1],_ = restoration.unsupervised_wiener(blur_image[:,:,1], PSF_blur) 
image_deblur[:,:,2],_ = restoration.unsupervised_wiener(blur_image[:,:,2], PSF_blur) 
# ---------------------------------------------------------
