...
import SuggestedAnecdotesAdminPage from "./pages/SuggestedAnecdotesAdminPage" // Новый импорт
        ...
        <DropdownProvider>
          <ClickOutsideHandler>
            <Routes>
              ...
              <Route path="/suggest-anecdote" element={<SuggestAnecdotePage />} />
              <Route path="/suggested-anecdotes-admin" element={<SuggestedAnecdotesAdminPage />} />{" "}
              {/* Новый маршрут */}
