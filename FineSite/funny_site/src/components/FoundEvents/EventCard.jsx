...
import { EventImagesGallery } from "../EventImagesGallery"
...
export const EventCard = ({ event, onDelete, navigate, canEdit, setFoundEvents }) => {
  return (
    <li key={event.IdEvent} className="card">
      ...
      {/* Галерея изображений */}
      <EventImagesGallery eventId={event.IdEvent} />
      ...
      <ActionButtons event={event} onDelete={onDelete} navigate={navigate} canEdit={canEdit} />
    </li>
  )
}
